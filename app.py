...
st.markdown("<div style='font-size:20px;color:#EDF4C2'>Quality Assurance Engineer: Almas Baharlooie</div>", unsafe_allow_html=True)
...
col1, col2 = st.columns(2)
with col1:
    st.image('pic/pca-kmeans.png', caption='', use_column_width=True)
with col2:
    st.image('pic/sil-kmeans.png', caption='', use_column_width=True) 
...
col1, col2 = st.columns(2)
with col1:
    st.image('pic/pca-gaussian.png', caption='', use_column_width=True)
with col2:
    st.image('pic/sil-gaussian.png', caption='', use_column_width=True) 
...
col1, col2 = st.columns(2)
with col1:
    st.image('pic/pca-optics.png', caption='', use_column_width=True)
with col2:
    st.image('pic/sil-optics.png', caption='', use_column_width=True)   
...
col1, col2 = st.columns(2)
with col1:
    st.image('pic/pca-birch.png', caption='', use_column_width=True)
with col2:
    st.image('pic/sil-birch.png', caption='', use_column_width=True)  
...
col1, col2 = st.columns(2)
with col1:
    st.image('pic/pca-lof.png', caption='', use_column_width=True)
with col2:
    st.image('pic/sil-lof.png', caption='', use_column_width=True)  
